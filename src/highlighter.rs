...
use syntect::highlighting::{Color, Style, StyleModifier, Theme, ThemeItem, ThemeSettings, ScopeSelectors};
...
impl Highlighter {
    ...
    fn create_tokyonight_theme() -> Theme {
        ...
        let bg = Color { r: 0x1a, g: 0x1b, b: 0x26, a: 0xff };
        let fg = Color { r: 0xc0, g: 0xca, b: 0xf5, a: 0xff };
        let comment = Color { r: 0x56, g: 0x5f, b: 0x89, a: 0xff };
        let cyan = Color { r: 0x7d, g: 0xcf, b: 0xff, a: 0xff };
        let green = Color { r: 0x9e, g: 0xce, b: 0x6a, a: 0xff };
        let orange = Color { r: 0xff, g: 0x9e, b: 0x64, a: 0xff };
        let magenta = Color { r: 0xbb, g: 0x9a, b: 0xf7, a: 0xff };
        let blue = Color { r: 0x7a, g: 0xa2, b: 0xf7, a: 0xff };
        let blue1 = Color { r: 0x2a, g: 0xc3, b: 0xde, a: 0xff };
        let blue5 = Color { r: 0x89, g: 0xdd, b: 0xff, a: 0xff };
        let red = Color { r: 0xf7, g: 0x76, b: 0x8e, a: 0xff };
        let _yellow = Color { r: 0xe0, g: 0xaf, b: 0x68, a: 0xff };
        let purple = Color { r: 0x9d, g: 0x7c, b: 0xd8, a: 0xff };
        ...
        Theme {
            ...
            settings: ThemeSettings {
                ...
                background: Some(bg),
                caret: Some(fg),
                line_highlight: Some(Color { r: 0x29, g: 0x2e, b: 0x42, a: 0xff }),
                selection: Some(Color { r: 0x28, g: 0x34, b: 0x57, a: 0xff }),
                ..Default::default()
            },
            scopes: vec![
                // Comments
                ...
                // Meta/Macros
                ThemeItem {
                    scope: ScopeSelectors::from_str("meta.macro, entity.name.function.macro").unwrap(),
                    style: StyleModifier {
                        foreground: Some(blue),
                        background: None,
                        font_style: None,
                ...
                // Namespaces/Modules
                ThemeItem {
                    scope: ScopeSelectors::from_str("entity.name.namespace, entity.name.module").unwrap(),
                    style: StyleModifier {
...
pub fn style_to_crossterm_color(style: Style) -> (crossterm::style::Color, crossterm::style::Color) {
